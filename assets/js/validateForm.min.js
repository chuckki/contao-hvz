...
$(document).ready(function() {
    ...
    function lookupRabatt(){
        ...
        if (str.length == 0) {
            ...
            xmlhttp.open("GET", "/system/modules/hvz/assets/giveMyRabatt.php?q=" + str, true);
            xmlhttp.send();
        }
    }
    ...
    $("body").append('<img style="display:none;" src="/files/hvb-theme/img/loading32x32.gif" />');
    ...
    function validateRechnungsAdresse(typ){
        ...
        if(typ=='bestellung'){
            ...
            var mystreet = $('input[name=StrasseRechnung]');
            var myOrt = $('input[name=OrtRechnung]');
            if($(myVorname).val() == ""){
...
(function ($) {
    $.loader_ext = {
        defaults: {
            ...
            title: '',
            isOnly: true,
            imgUrl: '/files/hvb-theme/img/loading32x32.gif',
            onShow: function () {
            },
            onClose: function () {
            }
