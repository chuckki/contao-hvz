...
class ModuleHvzListDropDown extends \Module
{
    ...
    public function generate()
    {
        ...
        if (TL_MODE == 'FE')
        {
            $GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/hvz/assets/js/typeahead.bundle.min.js|static';
            $GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/hvz/assets/js/searchlist.min.js|static';
        }
    ...
    protected function compile()
    {
        ...
        //        $this->Template->suche = $this->Input->get('suche');
...
*/
    ...
    protected function generateHvzLink($objHvz)
    {
        ...
        //$this->arrTargets[$jumpTo] = $objHvz->alias;
        return sprintf(
