...
class ModuleHvzReader extends \Module
{
    ...
    public function generate()
    {
        ...
        if (TL_MODE == 'FE') {
            $GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/hvz/assets/js/pikaday.min.js|static';
            $GLOBALS['TL_BODY'][]= '<script src="/system/modules/hvz/assets/js/validateForm.min.js"></script>';
        }
