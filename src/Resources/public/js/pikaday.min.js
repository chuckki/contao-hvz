! function(t, e) {
    ...
    var e = "function" == typeof t,
        ...
        r = function(t, e, n) {
            var a;
            i.createEvent ? (a = i.createEvent("HTMLEvents"), a.initEvent(e, !0, !1), a = v(a, n), t.dispatchEvent(a)) : i.createEventObject && (a = i.createEventObject(), a = v(a, n), t.fireEvent("on" + e, a))
        },
        h = function(t) {
        ...
        v = function(t, e, n) {
            var i, a;
            for (i in e) a = void 0 !== t[i], a && "object" == typeof e[i] && null !== e[i] && void 0 === e[i].nodeName ? c(e[i]) ? n && (t[i] = new Date(e[i].getTime())) : f(e[i]) ? n && (t[i] = e[i].slice(0)) : t[i] = v({}, e[i], n) : (n || !a) && (t[i] = e[i]);
            return t
        },
        _ = function(t) {
        ...
        N = function(t) {
            var e, n = [];
            for (t.showWeekNumber && n.push("<th></th>"), e = 0; 7 > e; e++) n.push('<th scope="col"><abbr title="' + b(t, e) + '">' + b(t, e, !0) + "</abbr></th>");
        ...
        j = function(s) {
            ...
            r._onMouseDown = function(t) {
                ...
                do
                    if (l(t, "pika-single")) return; while (t = t.parentNode);
                ...
                if (e) {
                    ...
                    do
                        if (l(i, "pika-single") || i === h.trigger) return; while (i = i.parentNode);
                    r._v && e !== h.trigger && i !== h.trigger && r.hide()
                }
            }, r.el = i.createElement("div"), r.el.className = "pika-single" + (h.isRTL ? " is-rtl" : ""), o(r.el, "mousedown", r._onMouseDown, !0), o(r.el, "change", r._onChange), h.field && (h.container ? h.container.appendChild(r.el) : h.bound ? i.body.appendChild(r.el) : h.field.parentNode.insertBefore(r.el, h.field.nextSibling), o(h.field, "change", r._onInputChange), h.defaultDate || (h.defaultDate = e && h.field.value ? t(h.field.value, h.format).toDate() : new Date(Date.parse(h.field.value)), h.setDefaultDate = !0));
            var u = h.defaultDate;
    ...
    return j.prototype = {
        config: function(t) {
            ...
            if (e.numberOfMonths = n > 4 ? 4 : n, c(e.minDate) || (e.minDate = !1), c(e.maxDate) || (e.maxDate = !1), e.minDate && e.maxDate && e.maxDate < e.minDate && (e.maxDate = e.minDate = !1), e.minDate && (g(e.minDate), e.minYear = e.minDate.getFullYear(), e.minMonth = e.minDate.getMonth()), e.maxDate && (g(e.maxDate), e.maxYear = e.maxDate.getFullYear(), e.maxMonth = e.maxDate.getMonth()), f(e.yearRange)) {
                var i = (new Date).getFullYear() - 10;
                e.yearRange[0] = parseInt(e.yearRange[0], 10) || i, e.yearRange[1] = parseInt(e.yearRange[1], 10) || i
            } else e.yearRange = Math.abs(parseInt(e.yearRange, 10)) || D.yearRange, e.yearRange > 100 && (e.yearRange = 100);
            return e
        },
        toString: function(n) {
        ...
        setDate: function(t, e) {
            ...
            if ("string" == typeof t && (t = new Date(Date.parse(t))), c(t)) {
                var n = this._o.minDate,
                    i = this._o.maxDate;
                if (c(n) && n > t ? t = n : c(i) && t > i && (t = i), this._d = new Date(t.getTime()), g(this._d), this.gotoDate(this._d), this._o.field) {
                    this._o.field.value = this.toString() + "d";
                    var a = this._d;
                    this._o.field.value = ("0" + a.getDate()).slice(-2) + "." + ("0" + (a.getMonth() + 1)).slice(-2) + "." + a.getFullYear(), r(this._o.field, "change", {
                        firedBy: this
                    })
                }
        ...
        draw: function(t) {
            if (this._v || t) {
                ...
                for (var h = 0; h < e.numberOfMonths; h++) r += '<div class="pika-lendar">' + C(this, h, this.calendars[h].year, this.calendars[h].month, this.calendars[0].year) + this.render(this.calendars[h].year, this.calendars[h].month) + "</div>";
        ...
        adjustPosition: function() {
            if (!this._o.container) {
                ...
                (this._o.reposition && t + s > h || this._o.position.indexOf("right") > -1 && t - s + a.offsetWidth > 0) && (t = t - s + a.offsetWidth), (this._o.reposition && e + r > l + u || this._o.position.indexOf("top") > -1 && e - r - a.offsetHeight > 0) && (e = e - r - a.offsetHeight), this.el.style.cssText = ["position: absolute", "left: " + t + "px", "top: " + e + "px"].join(";")
            }
        },
        render: function(t, e) {
            var n = this._o,
                ...
                s = [],
                r = [];
            g(i), n.firstDay > 0 && (o -= n.firstDay, 0 > o && (o += 7));
            for (var h = a + o, l = h; l > 7;) l -= 7;
            h += 7 - l;
            for (var u = 0, d = 0; h > u; u++) {
                var f = new Date(t, e, 1 + (u - o)),
                    m = n.minDate && f < n.minDate || n.maxDate && f > n.maxDate,
                    v = c(this._d) ? y(f, this._d) : !1,
                    _ = y(f, i),
                    D = o > u || u >= a + o;
                r.push(w(1 + (u - o), e, t, v, _, m, D)), 7 === ++d && (n.showWeekNumber && r.unshift(M(u - o, e, t)), s.push(k(r, n.isRTL)), r = [], d = 0)
            }
            return T(n, s)
        },
        isVisible: function() {
    ...
    function(t, e) {
        ...
        t.fn.pikaday = function() {
            ...
            return n && n.length || (n = [{}]), this.each(function() {
                var i = t(this),
                    a = i.data("pikaday");
                if (a instanceof e) "string" == typeof n[0] && "function" == typeof a[n[0]] && a[n[0]].apply(a, Array.prototype.slice.call(n, 1));
                else if ("object" == typeof n[0]) {
                    var o = t.extend({}, n[0]);
                    o.field = i[0], i.data("pikaday", new e(o))
                }
            })
        }
    });