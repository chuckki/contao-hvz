...
$(document).ready(function () {
    ...
    $('#tags').on('typeahead:asyncreceive', function (evt, item, arg) {
        detachSearch();
    });
    $('#tags').on('typeahead:close', function (evt, item, arg, tay) {
        detachSearch();
    });
    $('#tags').on('typeahead:idle', function (evt, item, arg, tay) {
        detachSearch();
    });
    $('#tags').on('typeahead:asynccancel', function (evt, item, arg, tay) {
        detachSearch();
    });
