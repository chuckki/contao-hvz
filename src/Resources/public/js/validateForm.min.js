...
$(document).ready(function () {
    ...
    $("body").append('<div id="overlay"><div id="text"><i class="fa fa-spinner fa-spin fa-2x"></i>Bestellung wird verarbeitet</div></div>');
    ...
    // *****************************
    // handle betonnung
    $('#ctrl_65').change(function () {
        var selVal = $(this).val();
        if (selVal == 'Fahrzeug bis 3,5t') {
            $('#fahrzeugTonne').hide();
        } else {
            $('#fahrzeugTonne').show();
        }
    ...
    $('#submit').click(function (e) {
        ...
        if (hvz.length) {
            setPrice(hvz.data('price'), hvz.val(), hvz.data('hvztyp'));
        }
    ...
    function validatePayment() {
        ...
        if ($("input[name=Payment]:checked").length == 0) {
            $('#payments').before('<span class="error">' + errorIcon + 'Wählen Sie eine Zahlungsmethode</span>');
            isValid = false;
        }
        if (!isValid) {
...
function renderPreisWithRabat(value) {
    ...
    if ($('.sumNetto').length == 0) {
        $('.tagPreis').after('<tr class="sumBrutto"><td><strong>Zwischensumme</strong> <small>(' + MWST + '% MwSt enthalten)</small></td><td class="bruttoValue"></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr class="sumNetto"><td>Preis ohne ' + MWST + '% Mehrwertsteuer</td><td class="nettoValue"></td></tr><tr class="showRabatt"><td class="rabValue">- ' + parseInt(value) + '% Rabatt</td><td class="rabattValue"></td></tr><tr class="sumNettoWithRabatt"><td>Zwischensumme</td><td class="nettoRabattValue"></td></tr><tr class="MwstNettoWithRabatt"><td>' + MWST + '% Mehrwertsteuer</td><td class="mwst"></td></tr>');
    }
    updatePreis();
}
...
function getRoundMwst(value) {
    var myret = roundTo2((value / (100 + MWST)) * 100);
    return myret;
}

function setRoundMwst(value) {
    var myret = roundTo2(value * (MWST / 100));
    return myret;
}

function setPrice(hvzPreis, hvzName, hvzType) {
    ...
    text += '<table><tr><td class="hvzName">' + hvzName + '</td><td class="hvzPreis"></td></tr><tr class="tagPreis"><td class="tageDesc"></td><td class="tagePreis"></td></tr><tr class="sumPreis"><td><strong>Endpreis</strong> <small>(' + MWST + '% MwSt enthalten)</small></td><td class="gesamtPreis"></td></tr></table>';
...
function updatePreis() {
    if ($('#setprice').val() != 0) {
        ...
        if ($('#ctrl_122').val() == "") {
            ...
            var mwst = setRoundMwst(gesamt / 100 * (100 + MWST));
            ...
            var summeNetto = roundTo2(bruttoValue / (100 + MWST) * 100);
