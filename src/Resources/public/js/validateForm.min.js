...
function renderPreisWithRabat(value) {
    ...
    if ($('.sumNetto').length == 0) {
        $('.tagPreis').after('<tr class="sumBrutto"><td><strong>Zwischensumme</strong> <small>(16% MwSt enthalten)</small></td><td class="bruttoValue"></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr class="sumNetto"><td>Preis ohne 16% Mehrwertsteuer</td><td class="nettoValue"></td></tr><tr class="showRabatt"><td class="rabValue">- ' + parseInt(value) + '% Rabatt</td><td class="rabattValue"></td></tr><tr class="sumNettoWithRabatt"><td>Zwischensumme</td><td class="nettoRabattValue"></td></tr><tr class="MwstNettoWithRabatt"><td>16% Mehrwertsteuer</td><td class="mwst"></td></tr>');
    }
    updatePreis();
}
...
function getRoundMwst(value) {
    var myret = roundTo2((value / 116) * 100);
    return myret;
}

function setRoundMwst(value) {
    var myret = roundTo2(value * 0.16);
    return myret;
}
...
function setPrice(hvzPreis, hvzName, hvzType) {
    ...
    text += '<table><tr><td class="hvzName">' + hvzName + '</td><td class="hvzPreis"></td></tr><tr class="tagPreis"><td class="tageDesc"></td><td class="tagePreis"></td></tr><tr class="sumPreis"><td><strong>Endpreis</strong> <small>(16% MwSt enthalten)</small></td><td class="gesamtPreis"></td></tr></table>';
...
function updatePreis() {
    if ($('#setprice').val() != 0) {
        ...
        if ($('#ctrl_122').val() == "") {
            ...
            var mwst = setRoundMwst(gesamt / 100 * 116);
            ...
            var summeNetto = roundTo2(bruttoValue / 116 * 100);
