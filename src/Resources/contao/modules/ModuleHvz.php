...
class ModuleHvz extends Frontend
{
    ...
    private function calcValidPrices(&$arrSubmitted): void
    {
        ...
        $arrSubmitted['fullNetto'] = number_format(($arrSubmitted['fullPrice'] / 116 * 100), 2);
